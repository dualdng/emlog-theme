...
function widget_sort($title){
	...
	<a href="<?php echo BLOG_URL; ?>rss.php?sort=<?php echo $value['sid']; ?>" title="订阅该分类">RSS</a>
...
function blog_comments($comments){
	...
	<div class="comment" id="comment-<?php echo $comment['cid']; ?>">
		...
		<div class="poster"><b><?php echo $comment['poster']; ?> </b><br /><span class="comment-time"><?php echo $comment['date']; ?></span>
			<div class="comment-reply"><a href="#comment-<?php echo $comment['cid']; ?>" onclick="commentReply(<?php echo $comment['cid']; ?>,this)">回复</a></div></div>
...
function blog_comments_children($comments, $children){
	...
	<div class="comment comment-children" id="comment-<?php echo $comment['cid']; ?>">
		...
		<?php if($isGravatar == 'y'): ?><div class="avatar"><img src="<?php echo getGravatar($comment['mail']); ?>" /></div><?php endif; ?>
		<div class="poster"><b><?php echo $comment['poster']; ?> </b><br /><span class="comment-time"><?php echo $comment['date']; ?></span>
		<?php if($comment['level'] < 100): ?><div class="comment-reply"><a href="#comment-<?php echo $comment['cid']; ?>" onclick="commentReply(<?php echo $comment['cid']; ?>,this)">回复</a></div><?php endif; ?></div>
		<div class="comment-info">
			<div class="comment-content"><?php echo $comment['content']; ?></div>
