...
function widget_sort($title){
	...
	<a href="<?php echo BLOG_URL; ?>rss.php?sort=<?php echo $value['sid']; ?>" title="订阅该分类">RSS</a></a>
...
function blog_comments($comments){
	...
	<div class="comment" id="comment-<?php echo $comment['cid']; ?>">
		...
		<div class="poster"><b><?php echo $comment['poster']; ?> </b><br /><span class="comment-time"><?php echo $comment['date']; ?></span></div>
...
function blog_comments_children($comments, $children){
	...
	<div class="comment comment-children" id="comment-<?php echo $comment['cid']; ?>">
		...
		<div class="comment-info">
			<div class="comment-content"><?php echo $comment['content']; ?></div>
			<?php if($comment['level'] < 100): ?><div class="comment-reply"><a href="#comment-<?php echo $comment['cid']; ?>" onclick="commentReply(<?php echo $comment['cid']; ?>,this)">回复</a></div><?php endif; ?>
		</div>
		<?php blog_comments_children($comments, $comment['children']);?>
	</div>
	<?php endforeach; ?>
